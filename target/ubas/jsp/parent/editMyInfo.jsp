        ...
        <form class="layui-form" action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="parentId"  placeholder="请输入ID"  class="layui-input layui-disabled" value="${parent.parentId}" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">姓名</label>
                <div class="layui-input-block">
                    <input type="text" placeholder="请输入姓名"  class="layui-input layui-disabled" value="${parent.parentName}" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">身份</label>
                <div class="layui-input-block">
                    <input type="text" placeholder="请输入身份"  class="layui-input layui-disabled" value="家长" disabled>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">电话号码</label>
                <div class="layui-input-block">
                    <input type="text" name="parentTel" id="parentTel" required  lay-verify="phone" placeholder="请输入电话号码" autocomplete="off" class="layui-input" value="${parent.parentTel}">
                </div>
            </div>
...
<script>
    ...
    layui.use(['element','layer','form'], function () {
        ...
        function submit($,params){
            $.post('${path}/parent/editParent ', params, function (res) {
                if (res.status==1) {
